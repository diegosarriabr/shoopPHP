...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Pesquisar Produto..." name="product" required="required" />
...
if(!empty($_SESSION['cart'])){
	...
	?>
			...
			<div class="clearfix cart-total">
				...
				<a href="my-cart.php" class="btn btn-upper btn-primary btn-block m-t-20">Minhas Compras</a>	
			</div><!-- /.cart-total-->
...
<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="index.php" class="btn btn-upper btn-primary btn-block m-t-20">Continue Comprando</a>	
			</div><!-- /.cart-total-->
