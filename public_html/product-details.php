...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">OFERTAS QUENTES</h3>
...
?>
					...
					<div class="products">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary">Adicionar no Carrinho</a>
...
<?php } ?>
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Disponivel :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Taxa de envio :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Adicionar no Carrinho</a>
									</div>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://www.facebook.com/diego.sarria.986"></a></li>
						                <li><a class="fa fa-twitter" href="#"></a></li>
						                <li><a class="fa fa-linkedin" href="https://www.linkedin.com/in/diego-sarria-bb3a6919b/"></a></li>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#review">Avaliar</a></li>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Avaliação do Produto</h4>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Price :</b>  <?php echo htmlentities($rvw['price']);?> Estrela</div>
													<div class="text"><b>value :</b>  <?php echo htmlentities($rvw['value']);?> Estrela</div>
										...
										<div class="product-add-review">
											<h4 class="title">Deixe sua avaliação nesse produto</h4>
											...
											<div class="review-form">
												<div class="form-container">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Reveja <span class="astk">*</span></label>
...
<textarea class="form-control txt txt-review" id="exampleInputReview" rows="4" placeholder="" name="review" required="required"></textarea>
														...
														<div class="action text-right">
															<button name="submit" class="btn btn-primary btn-upper">ENVIAR REVISÃO</button>
														</div><!-- /.action -->
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">Produto Relacionado </h3>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Adicionar no Carrinho</a>
