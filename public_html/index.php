...
<html lang="en">
	<head>
	    ...
	    <title>Compras Online Inicio</title>
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading Blue">DINHEIRO DE VOLTA</h4>
						</div>
					</div>	
					<h6 class="text">Garantia de devolução do dinheiro em 30 dias.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Compras gratis</h4>
						</div>
					</div>
					<h6 class="text">Envio gratuito ou mais Rs. 600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading Blue">VENDA ESPECIAL</h4>
						</div>
					</div>
					<h6 class="text">Todos os itens-venda com até 40% de desconto </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">produtos em destaque</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">Todos</a></li>
					<li><a href="#books" data-toggle="tab">Livros</a></li>
					<li><a href="#furniture" data-toggle="tab">Mobília</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					...
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Adicionar no Carrinho</a></div>
			</div><!-- /.product -->
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Computadores portáteis</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
