...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle">Criar uma Conta</h4>
	<p class="text title-tag-line">Crie sua própria conta do Shopping.</p>
...
<div class="form-group">
	    	<label class="info-title" for="contactno">Telefone <span>*</span></label>
...
<div class="form-group">
	  	...
	  	<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button" id="submit">Cadastre-se</button>
	</form>
	<span class="checkout-subtitle outer-top-xs">Inscreva-se hoje!!  </span>
	<div class="checkbox">
	  	<label class="checkbox">
		  	Acelere o processo de Compras.
		</label>
		<label class="checkbox">
		Acompanhe seus pedidos facilmente.
		</label>
		<label class="checkbox">
 Mantenha-se seu registro de todas as suas compras.
		</label>
	</div>
</div>	
