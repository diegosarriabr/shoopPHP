...
<head>
	...
	<title>Administração| Inserir produto</title>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Digite o nome da empresa do produto" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="control-group">
<label class="control-label" for="basicinput">Preço do produto após desconto (preço de venda)</label>
<div class="controls">
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Insira a taxa de envio do produto" class="span8 tip" required>
</div>
</div>
