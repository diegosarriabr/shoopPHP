...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Esse produto foi deletado !!";
		  }
...
{?>
									...
									<strong>Ops!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
<?php } ?>
...
?>									
										<tr>
											...
											<a href="manage-products.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Tem certeza de que deseja excluir?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
