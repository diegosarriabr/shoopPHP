...
<head>
	...
	<title>Administrador| Mudar senha</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Senha de alteração do administrador</h3>
							</div>
...
<label class="control-label" for="basicinput">senha Antiga</label>
<div class="controls">
<input type="password" placeholder="Digite sua senha Antiga"  name="password" class="span8 tip" required>
</div>
</div>
