...
$_SESSION['msg']="Esse Produto foi atualizado com sucesso !!";
...
{?>
									...
									<strong>Pronto!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Digite o nome da empresa do produto" value="<?php echo htmlentities($row['productCompany']);?>" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Insira a taxa de envio do produto" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Disponibilidade de produto</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagem do Produto 1</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id'];?>">Alterar imagem</a>
</div>
</div>


<div class="control-group">
<label class="control-label" for="basicinput">Imagem do Produto 2</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id'];?>">Alterar imagem</a>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagem do Produto 3</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id'];?>">Alterar imagem</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
