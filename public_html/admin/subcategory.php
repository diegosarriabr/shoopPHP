...
<head>
	...
	<title>Administração| da Sub-Categoria</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nome da sub-categoria</label>
<div class="controls">
<input type="text" placeholder="Digite o nome da sub-categoria"  name="subcategory" class="span8 tip" required>
</div>
</div>
