	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Verificação de saida</li>
			</ul>
	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title">
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	          <span>1</span>Endereco de cobranca
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Endereco de cobranca<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Estado de faturamento  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Cidade de cobranca <span>*</span></label>
						    ...
						    <div class="panel-heading">
						      <h4 class="unicase-checkout-title">
						        <a data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseTwo">
						          <span>2</span>Endereco de entrega
						        </a>
						      </h4>
						    </div>
...
?>
					...
					<form class="register-form" role="form" method="post">
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Endereco de entrega<span>*</span></label>
			 ...
			 <input type="text" class="form-control unicase-form-control text-input" id="shippingstate" name="shippingstate" value="<?php echo $row['shippingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Cidade de embarque <span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Codigo de remessa <span>*</span></label>
