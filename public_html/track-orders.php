...
<div class="body-content outer-top-bd">
	...
	<span class="title-tag inner-top-vs">Digite seu ID do pedido na caixa abaixo e pressione Enter. Isso foi fornecido no seu recibo e no e-mail de confirmação que você deveria ter recebido. </span>
	<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">ID do pedido</label>
