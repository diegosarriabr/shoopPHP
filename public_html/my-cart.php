		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-product-name item">Produto</th>
			
					<th class="cart-qty item">Quantidade</th>
					<th class="cart-sub-total item">Preço por unidade</th>
					<th class="cart-sub-total item">Taxa de envio</th>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continue comprando</a>
								<input type="submit" name="submit" value="Atualizar Compras" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">ENDEREÇO ​​DE ENTREGA</span>
				</th>
			</tr>
		</thead>
		<tbody>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">Confirmar a Compra</button>
